...
const Brand=({dark=false,size=39}:{dark?:boolean,size?:number})=>
...
function App(){
 ...
 return <div>
  ...
  <main>
   ...
   <section id="gallery" className="section"><div className="section-head"><div><div className="section-tag">GALLERY</div><h2>Stories of <span>service.</span></h2></div><Images/></div><div className="gallery">{[...activities,["Community Support","https://images.unsplash.com/photo-1559027615-cd4628902d4a?auto=format&fit=crop&w=1200&q=80"],["Rural Community","https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=1200&q=80"]].map(([t,s])=><div key={t}><Img src={s} alt={t}/><span>{t}</span></div>)}</div></section>
